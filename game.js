...
<head>
    ...
    <meta name="description" content="Great free games are waiting for you with the gamebol. How about playing your favorite games nonstop.">
    <meta charset="UTF-8">
    ...
    <meta property="og:url" content="https://gamebol.com/404">
    <meta property="og:type" content="game">
    <meta property="og:title" content="Page Not Found">
    <meta property="og:description" content="Great free games are waiting for you with the gamebol. How about playing your favorite games nonstop.">
        <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Page Not Found">
    <meta name="twitter:url" content="https://gamebol.com/404">
    <meta name="twitter:description" content="Great free games are waiting for you with the gamebol. How about playing your favorite games nonstop.">
    
    <link rel="canonical" href="https://gamebol.com/404">
...
<body class="min-vh-100 layout d-flex flex-column"><nav style="background-image: none; background: rgba(33, 34, 51, 0.9); backdrop-filter: blur(8px); justify-content: space-between; flex-flow: wrap; box-shadow: 0px 3px 3px -2px rgba(0,0,0,0.2), 0px 3px 4px 0px rgba(0,0,0,0.14), 0px 1px 8px 0px rgba(0,0,0,0.12); z-index:1000;position:fixed; width:100%;" class="navbar navbar-expand-lg layout-header navbar-dark">
    <div class="container-fluid">
        ...
        <img src="https://gamebol.com/public/static/logo.png"
         alt="Gamebol"
         style="height:40px; width:auto;">
        </a>

         <a href="https://gamebol.com" class="navbar-brand light-logo me-lg-4">
         <img src="https://gamebol.com/public/static/dark_logo.png"
         alt="Gamebol"
         style="height:40px; width:auto;">
         </a>
        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <form class="form-search w-xxl-300 w-xl-250 ms-xl-4 mb-3 mb-lg-0 align-items-xl-center ms-xl-auto"
                ...
                <input type="hidden" name="_TOKEN" value="JDJ5JDEwJExnTVNobXZlZzczc1lRTDdWQ1E3M09LTjVIMzgzU0IzM0JZUVh0LkhpdVd0SGxnRXlULmR1">
...
<div class="mx-auto py-5 px-2"></div><div class="container">
    <div class="text-center py-8">
        <div class="text-theme">
            <svg width="160" height="160" fill="currentColor">
                <use xlink:href="https://gamebol.com/public/assets/sprite/sprite.svg#monster"></use>
            </svg>
        </div>
    ...
    <script defer="" src="https://gamebol.com/app/theme/assets/js/main.js?v=1.0.0&a=46"></script>
